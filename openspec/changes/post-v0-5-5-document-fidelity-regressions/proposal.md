...
- PPTX変換のstage別時間を計測し、同一sourceの不要な再変換を防止する。
...
- KDVのspreadsheet artifact、worker protocol、document session、neutral grid frame、Office preflight、paged conversion cacheを変更する。
